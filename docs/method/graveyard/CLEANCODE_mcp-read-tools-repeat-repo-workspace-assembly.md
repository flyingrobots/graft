...
Retired because the exact duplication no longer exists. The MCP read-family tools now share `createRepoWorkspaceFromToolContext(...)` instead of rebuilding the adapter bundle inline.
