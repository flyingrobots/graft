...
Implemented via the direct root-package API surface, explicit public API contract, and built-in dirty-buffer StructuredBuffer integration. Graft now documents and exports the editor-facing in-process path without requiring MCP or CLI as architectural truth.

Replacement: `docs/public-api.md`
