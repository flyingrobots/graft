...
design_doc: "docs/design/WARP_local-causal-history-graph-schema.md"
outcome: hill-met
drift_check: yes
---
...
- Repo-visible playback witness:
  - [0074-local-causal-history-graph-schema.test.ts](./tests/playback/0074-local-causal-history-graph-schema.test.ts:1)
- Verification note:
  - [verification.md](./docs/method/retro/0074-local-causal-history-graph-schema/witness/verification.md:1)
