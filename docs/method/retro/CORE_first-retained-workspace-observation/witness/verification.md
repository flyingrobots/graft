...
`scripts/generate-backlog-dependency-dag.ts` — 143 cards, 15 edges — and no
generated byte was hand-resolved. The two unresolved dependency refs it reports
are pre-existing and reference a card outside this cycle.
