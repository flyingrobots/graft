...
- [CORE_hex-layer-map-and-dependency-guardrails.md](../method/backlog/asap/CORE_hex-layer-map-and-dependency-guardrails.md#L1)
...
- [CORE_primary-adapters-thin-use-case-extraction.md](../method/backlog/up-next/CORE_primary-adapters-thin-use-case-extraction.md#L1)

Existing backlog clusters that fold into this slice:

- [CLEAN_CODE_mcp-context.md](../method/backlog/bad-code/CLEAN_CODE_mcp-context.md#L1)
- [CLEAN_CODE_cli-main.md](../method/backlog/bad-code/CLEAN_CODE_cli-main.md#L1)
- [CLEAN_CODE_mcp-tool-code-find-orchestration.md](../method/backlog/bad-code/CLEAN_CODE_mcp-tool-code-find-orchestration.md#L1)
- [CLEAN_CODE_mcp-tool-map-collector-orchestration.md](../method/backlog/bad-code/CLEAN_CODE_mcp-tool-map-collector-orchestration.md#L1)
...
- [CORE_warp-port-and-adapter-boundary.md](../method/backlog/up-next/CORE_warp-port-and-adapter-boundary.md#L1)

Existing backlog clusters that fold into this slice:

- [CLEAN_CODE_warp-plumbing-declaration.md](../method/backlog/bad-code/CLEAN_CODE_warp-plumbing-declaration.md#L1)
- [CLEAN_persisted-local-history-bypasses-git-warp-causal-graph.md](../method/backlog/bad-code/CLEAN_persisted-local-history-bypasses-git-warp-causal-graph.md#L1)
- [CLEAN_CODE_mcp-persisted-local-history-composition.md](../method/backlog/bad-code/CLEAN_CODE_mcp-persisted-local-history-composition.md#L1)
...
- [CORE_composition-roots-for-cli-mcp-daemon-and-hooks.md](../method/backlog/up-next/CORE_composition-roots-for-cli-mcp-daemon-and-hooks.md#L1)

Existing backlog clusters that fold into this slice:

- [CLEAN_CODE_mcp-server.md](../method/backlog/bad-code/CLEAN_CODE_mcp-server.md#L1)
- [CLEAN_CODE_mcp-workspace-router-composition.md](../method/backlog/bad-code/CLEAN_CODE_mcp-workspace-router-composition.md#L1)
- [CLEAN_CODE_mcp-daemon-server-lifecycle-composition.md](../method/backlog/bad-code/CLEAN_CODE_mcp-daemon-server-lifecycle-composition.md#L1)
- [CLEAN_CODE_mcp-daemon-control-plane-composition.md](../method/backlog/bad-code/CLEAN_CODE_mcp-daemon-control-plane-composition.md#L1)
...
- [CORE_runtime-validated-command-and-context-models.md](../method/backlog/up-next/CORE_runtime-validated-command-and-context-models.md#L1)

Existing backlog clusters that fold into this slice:

- [CLEAN_CODE_contracts-output-schemas.md](../method/backlog/bad-code/CLEAN_CODE_contracts-output-schemas.md#L1)
- [CLEAN_CODE_mcp-receipt.md](../method/backlog/bad-code/CLEAN_CODE_mcp-receipt.md#L1)
- [CLEAN_CODE_mcp-tool-safe-read.md](../method/backlog/bad-code/CLEAN_CODE_mcp-tool-safe-read.md#L1)
- [CLEAN_CODE_mcp-tool-doctor.md](../method/backlog/bad-code/CLEAN_CODE_mcp-tool-doctor.md#L1)
...
- [CLEAN_CODE_parser-outline.md](../method/backlog/bad-code/CLEAN_CODE_parser-outline.md#L1)
- [CLEAN_CODE_operations-graft-diff.md](../method/backlog/bad-code/CLEAN_CODE_operations-graft-diff.md#L1)
- [CLEAN_CODE_mcp-runtime-observability-composition.md](../method/backlog/bad-code/CLEAN_CODE_mcp-runtime-observability-composition.md#L1)
...
- [CORE_composition-roots-for-cli-mcp-daemon-and-hooks.md](../method/backlog/up-next/CORE_composition-roots-for-cli-mcp-daemon-and-hooks.md#L1)
- [CORE_runtime-validated-command-and-context-models.md](../method/backlog/up-next/CORE_runtime-validated-command-and-context-models.md#L1)
- [CLEAN_architecture-doc-overclaims-strict-hexagonal-posture.md](../method/backlog/bad-code/CLEAN_architecture-doc-overclaims-strict-hexagonal-posture.md#L1)
