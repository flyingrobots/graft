...
- `node bin/graft.js --cwd <repo-root> diag doctor --json`
- `node bin/graft.js --cwd <repo-root> read outline src/index.ts --json`
- `node bin/graft.js --cwd <repo-root> struct map src --json`
