...
export const CAPABILITY_REGISTRY: readonly CapabilityDefinition[] = [
  ...
  defineCapability({
    id: "graft_import_diagnostics",
    description: "Import binding shadow diagnostics for qualified reference inference",
    mcpTool: "graft_import_diagnostics",
    cliCommand: "struct_import_diagnostics",
    cliPath: ["struct", "import-diagnostics"],
    cliMcpParity: "peer",
  }),
  defineCapability({
